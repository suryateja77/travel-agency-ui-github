...
//                     { key: 'new', value: 'New' },
//                   ]}
//                   value={regularRequest.customerType === 'existing' ? 'Existing' : 'New'}
//                   changeHandler={value => {
//                     const selectedType = value.customerType === 'Existing' ? 'existing' : 'new'
//                     console.log('Customer Type Change:', selectedType)
//                     setRegularRequest(prev => ({
//                       ...prev,
//                       customerType: selectedType as 'existing' | 'new',
//                       customerCategory: selectedType === 'new' ? null : prev.customerCategory,
//                       customer: selectedType === 'new' ? null : prev.customer,
//                       customerDetails: selectedType === 'existing' ? null : { name: '', contact: '', email: '' },
//                     }))
//                   }}
//                   showPlaceholder={false}
//                   required
//                   errorMessage={regularRequestErrorMap['customerType']}
//                   invalid={!!regularRequestErrorMap['customerType']}
//                 />
//               </Column>
//             </Row>
...
//                     { key: 'new', value: 'New' },
//                   ]}
//                   value={regularRequest.vehicleType === 'existing' ? 'Existing' : 'New'}
//                   changeHandler={value => {
//                     const selectedType = value.vehicleType === 'Existing' ? 'existing' : 'new'
//                     setRegularRequest(prev => ({
//                       ...prev,
//                       vehicleType: selectedType as 'existing' | 'new',
//                       vehicleCategory: selectedType === 'new' ? null : prev.vehicleCategory,
//                       vehicle: selectedType === 'new' ? null : prev.vehicle,
//                       vehicleDetails: selectedType === 'existing' ? null : { ownerName: '', ownerContact: '', ownerEmail: '', manufacturer: '', name: '', registrationNo: '' },
//                       packageFromProvidedVehicle: selectedType === 'existing' ? undefined : { packageCategory: '', package: '' },
//                     }))
//                   }}
//                   showPlaceholder={false}
//                   required
//                   errorMessage={regularRequestErrorMap['vehicleType']}
//                   invalid={!!regularRequestErrorMap['vehicleType']}
//                 />
//               </Column>
//             </Row>
...
//                     { key: 'new', value: 'New' },
//                   ]}
//                   value={regularRequest.staffType === 'existing' ? 'Existing' : 'New'}
//                   changeHandler={value => {
//                     const selectedType = value.staffType === 'Existing' ? 'existing' : 'new'
//                     setRegularRequest(prev => ({
//                       ...prev,
//                       staffType: selectedType as 'existing' | 'new',
//                       staffCategory: selectedType === 'new' ? null : prev.staffCategory,
//                       staff: selectedType === 'new' ? null : prev.staff,
//                       staffDetails: selectedType === 'existing' ? null : { name: '', contact: '', license: '' },
//                     }))
//                   }}
//                   showPlaceholder={false}
//                   required
//                   errorMessage={regularRequestErrorMap['staffType']}
//                   invalid={!!regularRequestErrorMap['staffType']}
//                 />
//               </Column>
//             </Row>
