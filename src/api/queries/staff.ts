...
const { get, getById, create, updateById, delete: deleteById, getByCategory, exportExcel, exportCsv } = generateAPIMethods('/staff')
...
export const useStaffByCategory = (category: string) => {
  return useQuery({
    queryKey: ['staffs', category],
    queryFn: async () => {
