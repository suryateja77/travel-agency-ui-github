...
const { get, getById, create, updateById, delete: deleteById, getByCategory, exportExcel, exportCsv } = generateAPIMethods('/customer')
...
export const useCustomerByCategory = (category: string) => {
  return useQuery({
    queryKey: ['customers', category],
    queryFn: async () => {
